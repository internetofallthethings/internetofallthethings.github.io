...
* __[!]__ Removed `.pure-g-r` from core, in favor of a mobile-first responsive
  ...
  website:
    ...
    ```html
    <link rel="stylesheet" href="/css/pure/0.5.0-rc-1/pure-min.css">

    <!--[if lt IE 9]>
        <link rel="stylesheet" href="/css/pure/0.5.0-rc-1/grids-responsive-old-ie-min.css">
    <![endif]-->
    <!--[if gt IE 8]><!-->
        <link rel="stylesheet" href="/css/pure/0.5.0-rc-1/grids-responsive-min.css">
    <!--<![endif]-->
    ```
